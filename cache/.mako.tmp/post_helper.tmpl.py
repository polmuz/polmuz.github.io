...
_magic_number = 10
_modified_time = 1415152661.556112
_enable_loop = True
_template_filename = u'/home/pablo/.virtualenvs/blog/local/lib/python2.7/site-packages/nikola/data/themes/base/templates/post_helper.tmpl'
    ...
    try:
        ...
        if use_open_graph:
            ...
            if post.previewimage:
                ...
                __M_writer(unicode(post.previewimage))
                __M_writer(u'">\n')
